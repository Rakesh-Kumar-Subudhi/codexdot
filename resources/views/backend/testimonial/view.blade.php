            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    ...
                    <div class="ms-auto pageheader-btn">
                        ...
                        <a href="{{ url('/create_testimonial') }}"><button type="button" class="btn btn-primary"><i
                                    class="fe fe-plus"></i> Add Testimonial</button></a>
                                    ...
                                    <table id="data-table" class="table table-bordered text-nowrap mb-0">
                                        <thead class="border-top">
                                            <tr>
                                                ...
                                                <th class="bg-transparent border-bottom-0">Link</th>
                                        ...
                                        <tbody>
                                            @foreach ($testimonial as $testimonials)
                                                <tr class="border-bottom">
                                                    ...
                                                    <td class="text-muted fs-15 fw-semibold">{{ $testimonials->name }}</td>
                                                    <td class="text-muted fs-15 fw-semibold">
                                                        {{ $testimonials->designation }}
                                                    </td>
                                                    <td class="text-muted fs-15 fw-semibold">{{ $testimonials->link }}</td>
                                                    <td class="text-muted fs-15 fw-semibold">{{ $testimonials->message }}
                                                    </td>
                                                    ...
                                                    <td class="">
                                                        <a href="{{ url('/edit_testimonial', ['id' => $testimonials->id]) }}"
                                                        ...
                                                        <a href="{{ url('/testimonial_delete', ['id' => $testimonials->id]) }}"
